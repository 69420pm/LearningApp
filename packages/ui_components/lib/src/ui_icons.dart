...
class UIIcons {
  ...
  static UIIcon addFolder = const UIIcon(Icons.create_new_folder_rounded, size:32);
  static UIIcon share = const UIIcon(Icons.share_rounded, size:32);
  static UIIcon classTest = const UIIcon(Icons.calendar_month_rounded, size: 32,);
  static UIIcon edit = const UIIcon(Icons.edit_rounded, size: 24,);
  static UIIcon delete = const UIIcon(Icons.delete_rounded, size:26, color: UIColors.delete,);
  ...
  static UIIcon done = const UIIcon(Icons.done_rounded, size: 32,);
  static UIIcon formatBold = const UIIcon(Icons.format_bold_rounded, size: 32);
  static UIIcon formatItalic = const UIIcon(Icons.format_italic_rounded, size: 32);
  static UIIcon formatUnderline = const UIIcon(Icons.format_underline_rounded, size: 32);
  static UIIcon alternateEmail = const UIIcon(Icons.alternate_email_rounded, size: 32);
  static UIIcon formatColorText = const UIIcon(Icons.format_color_text_rounded, size: 32);
  static UIIcon formatColorFill = const UIIcon(Icons.format_color_fill_rounded, size: 32);
  ...
  static UIIcon horizontalRule = const UIIcon(Icons.horizontal_rule_rounded, size: 32);
  static UIIcon formatListBulleted = const UIIcon(Icons.format_list_bulleted_rounded, size: 32);
  static UIIcon formatListNumbered = const UIIcon(Icons.format_list_numbered_rounded, size: 32);
  static UIIcon formatQuote = const UIIcon(Icons.format_quote_rounded, size: 32);
  ...
  static UIIcon photoLibrary = const UIIcon(Icons.photo_library_rounded, size:32);
  static UIIcon zoomIn = const UIIcon(Icons.zoom_in_rounded, size: 32);
  static UIIcon alignment = const UIIcon(Icons.format_align_center_rounded, size:32);
  ...
  static UIIcon arrowRight = const UIIcon(Icons.arrow_right_alt_rounded, size:32);
  ...
  static UIIcon chevronRight = const UIIcon(Icons.chevron_right_outlined, size:36);
  static UIIcon chevronLeft = const UIIcon(Icons.chevron_left_outlined, size:36);
